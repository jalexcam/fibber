...
use Psr\Container\ContainerInterface as ContainerInterfaceContract;

/**
 * Get the methods of Container: get() and has().
 */
interface ContainerInterface extends ContainerInterfaceContract
{
    //
}