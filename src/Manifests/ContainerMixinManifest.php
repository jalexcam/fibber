...
class ContainerMixinManifest
{
    ...
    public function __construct(string $basePath, ?string $containerMixinPath = null)
    {
        ...
        $this->containerMixinPath = $containerMixinPath ?? $basePath.'/vendor/jalexcam/fibber/src/Container/ContainerMixin.php';
    }
     ...
     * @return void
     */
    public function buildIfShould(array $extensionMethods, array $extensions): void
    {
     ...
     * @return void
     */
    public function build(array $extensionMethods, array $extensions): void
    {
        $tags = [];
        ...
        $this->write($serializer->getDocComment($docBlock));
    }
