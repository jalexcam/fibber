...
/**
 * The message of exception: no option locale found.
 */
class NoOptionLocaleFoundException extends RuntimeException
{
    /**
     * Constructor. Create a new NoOptionLocaleFoundException instance.
     * 
